---
title: "Opening & merging DD output views"
...
library(XLConnect) # package to open xlsx files with password encryption; if you don't need to open a password encrypted file, openxlsx is another good package
...
raw_data_path <- "/Users/emurbanw/Dropbox (University of Michigan)/MED-EFDC-data-design/Example_code/DataDirect/data/raw/"
clean_data_path <- "/Users/emurbanw/Dropbox (University of Michigan)/MED-EFDC-data-design/Example_code/DataDirect/data/clean/"
...
wb <- loadWorkbook(paste0(raw_data_path, "Example_DD_data.xlsx"), password = rstudioapi::askForPassword(pw_message))
...
# Appending the data from each diagnosis sheet together (if there are more than 2 sheets, you would then rbind(diagnoses, diagnoses3) and so on)
# Because there shouldn't be any overlap between a specific visit diagnosis between sheets, we append rather than merge
diagnoses <- rbind(diagnoses1, diagnoses2)
...
# write.csv(data, ((paste0(clean_data_path, "Example_data_merged.csv"))))
